...
//				if (hasIdentifierProperty() && !ENTITY_ID.equals( getIdentifierPropertyName() ) ) {
	...
	public void update(
		...
		// ARNO : C'est ici que tout se passe :
	...
	/*	String[] whereClause = new String[span];
		if (dirtyFields!= null && oldFields != null) {
			for(int i=0;i++;i<count(oldFields)) {
				if (!dirtyFields.contains(i)) { 
					whereClause = 
					}
				}
			} */
