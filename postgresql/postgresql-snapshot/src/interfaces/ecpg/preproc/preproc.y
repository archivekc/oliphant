...
|  ALTER opt_column ColId SET STATISTICS DISTINCT NumericOnly
 { 
 $$ = cat_str(5,make_str("alter"),$2,$3,make_str("set statistics distinct"),$7);
}
...
|  CREATE opt_trusted opt_procedural LANGUAGE ColId_or_Sconst HANDLER handler_name opt_inline_handler opt_validator
 { 
